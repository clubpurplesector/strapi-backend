...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    driverTeamTrackSeasonTyre: Attribute.Text;
    grandPrixRace: Attribute.Text;
    chassisSeasonGrid: Attribute.Text;
    imageFromServer: Attribute.Boolean;
    apiFromServer: Attribute.Boolean;
    driverStandingsForSeasonJson: Attribute.JSON;
    teamStandingsForSeasonJson: Attribute.JSON;
    raceResultFastestLapForGrandPrixJson: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
